...
if (isset($_POST['updatesecondyear'])) {
    ...
    // if ($result2) {
        ...
        // // Redirect to the same page to refresh the student list
        // header("Location: update_student.php?id=$student_id");


        // $query = "UPDATE user SET user_id='$user_id',reg='$reg_no', username='$name',level='$level',phone='$phone',email='$email',password='$password',address='$address',image='$dst_db' WHERE id='$id' ";
